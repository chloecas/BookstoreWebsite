...
/* async function sortByPrice(){
    const lowSort = document.getElementById('lowHigh');
    const highSort = document.getElementById('highLow');
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    /* document.getElementById('highLow')
    .addEventListener(sortByPrice());
